...
#if defined(NDEBUG)
# error "xRadon cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "xRadon Signed Message:\n";
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
	...
	else if(pindexBest->nHeight+1 >= 30241 && pindexBest->nHeight+1 <= 555841)
    {
		nSubsidy = 5 * COIN;   // 1 year after 30241
    }
	else if(pindexBest->nHeight+1 >= 555842 && pindexBest->nHeight+1 <= 1081442)
    {
		nSubsidy = 4.5 * COIN;   // after 1 year drop 10%
    }
	else if(pindexBest->nHeight+1 >= 1081443 && pindexBest->nHeight+1 <= 1607043)
    {
		nSubsidy = 4.05 * COIN;  // after 2 years drop 10%
    }
	else if(pindexBest->nHeight+1 >= 1607044 && pindexBest->nHeight+1 <= 2132644)
    {
		nSubsidy = 3.64 * COIN;  // after 4 years drop 10%
    }
	else if(pindexBest->nHeight+1 >= 2132645 && pindexBest->nHeight+1 <= 2658245)
    {
		nSubsidy = 3.28 * COIN;  // after 5 years drop 10%
    }
	else if(pindexBest->nHeight+1 >= 2658246 && pindexBest->nHeight+1 <= 3183846)
    {
		nSubsidy = 2.95 * COIN;  // after 6 years drop 10%
    }
	else if(pindexBest->nHeight+1 >= 3183847 && pindexBest->nHeight+1 <= 3709447)
    {
		nSubsidy = 2.66 * COIN;  // after 7 years drop 10%
    }	
	else if(pindexBest->nHeight+1 >= 3709448 && pindexBest->nHeight+1 <= 4235048)
    {
		nSubsidy = 2.40 * COIN;  // after 8 years fixed
    }
	else if(pindexBest->nHeight+1 >= 4235049)
    {
		nSubsidy = 2.15 * COIN;  
    }
...
#ifdef ENABLE_WALLET
// xRadon: attempt to generate suitable proof-of-stake
